...
const imageUrls = [
    ...
    ['images/hk/bright.JPG', 'SPLENDOR'],
    ['images/hk/buddhe.JPG', 'Buddha guy'],
    ['images/hk/chicken.JPG', 'uhhh, chicken'],
    ['images/hk/ck.JPG', 'Circle K'],
    ['images/hk/flower.JPG', 'Nice flower'],
    ['images/hk/gates.JPG', 'cool gate'],
    ['images/hk/hk_pa.JPG', 'You just gotta keep waving'],
    ['images/hk/mnt.JPG', 'Lil hike'],
    ['images/hk/temple.JPG', 'cool temple'],
    ...
    ['images/miata/front.JPG', ':0'],
    ['images/miata/interior.JPG', 'mesa'],
    ...
    ['images/monkeys/actually_just_scratching.JPG', 'quick scratch'],
    ['images/monkeys/butts.JPG', 'Put that thing away!'],
    ['images/monkeys/CHASING_ME.JPG', 'Low key kinda scary'],
    ['images/monkeys/disbelief.JPG', 'Disbelief'],
    ['images/monkeys/golden_monkey.JPG', 'Got places to be!'],
    ['images/monkeys/jump.JPG', 'On the move'],
    ['images/monkeys/little_guy_schocked.JPG', 'AHHHH'],
    ['images/monkeys/little_nippy.JPG', 'Quick bite'],
    ['images/monkeys/little_tree_yellow_lips.JPG', 'Beady ahh eyes'],
    ['images/monkeys/mr_chill_solo.JPG', 'Thanks for being so chill, Mr. Chill'],
    ['images/monkeys/orange_peel.JPG', 'mmmmm, orang'],
    ['images/monkeys/stairs.JPG', 'moving fast'],
    ['images/monkeys/statue.JPG', 'Anatomically correct'],
    ['images/monkeys/swag.JPG', 'Swag'],
    ['images/monkeys/tree_chiller.JPG', '#MonitoringTheSituation'],
